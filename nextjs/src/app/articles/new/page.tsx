        ...
        <div className='min-h-screen py-8 px-4 md:px-12'>
            ...
            <form className='bg-slate-200 p-6 rounded shadow-lg' onSubmit={handleSubmit}> 
               ...
               <div className="mb-4">
                    ...
                    <input
                        type="text" className='shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none'
...
export default CreaeteBlogPage;
